...
import { FiCheckCircle, FiPackage, FiTag, FiStar, FiShare2 } from "react-icons/fi";
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: product.title,
          text: `Check out ${product.title} on Aurora!`,
          url: url
        });
      } catch (err) {
          ...
          <FadeIn delay={0.2} className="flex flex-col justify-center py-4">
            ...
            <div className="flex flex-col gap-4 max-w-md">
              ...
              <div className="flex items-center gap-3 mt-4">
                ...
                <button
                  onClick={handleShare}
                  className="flex-1 flex items-center justify-center gap-2 bg-gray-100 text-black py-3 rounded-xl font-bold hover:bg-gray-200 transition cursor-pointer"
                >
                  <FiShare2 /> Share
                </button>
              </div>
